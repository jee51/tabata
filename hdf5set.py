# -*- coding: utf-8 -*-
"""
HDF5SET - Gestion des liste d'observations stockées dans des fichiers au format HDF5.
...
def plot2(self, phase=None):
	...
	if len(self.phase) > 0:
		ind = df[self.phase]
		data.append(go.Scatter(x=df.index[ind], y=df[self.colname][ind], mode='markers'))
